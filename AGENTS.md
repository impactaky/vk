...
3. After completing each workflow step, report the result briefly and continue automatically to the next step unless blocked, destructive approval is required, or user input is necessary to resolve ambiguity.
