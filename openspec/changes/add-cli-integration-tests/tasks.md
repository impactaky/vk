...
- [ ] 1.1 Create CLI runner helper (`vk/tests/helpers/cli-runner.ts`)
...
- [ ] 1.2 Update deno.json permissions
  - Add `--allow-run=deno` to `test:integration` task

- [ ] 1.3 Create CLI integration tests (`vk/tests/cli_integration_test.ts`)
...
- [ ] 2.1 Run `deno task lint` - no lint errors
- [ ] 2.2 Run `deno task check` - no type errors
- [ ] 2.3 Run `deno task test` - unit tests pass
- [ ] 2.4 Run `deno task test:integration` - integration tests pass
