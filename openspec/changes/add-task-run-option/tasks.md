...
1. [ ] Add `--run` and `--executor` options to `task create` command
...
2. [ ] Implement attempt creation logic in task create action
...
4. [ ] Update cli-commands spec with new scenarios
