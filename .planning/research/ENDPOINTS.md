...
**Researched:** 2026-01-30 **Confidence:** HIGH (DeepWiki documentation
verified) **Sources:**
...
2. Get session_id from workspace (via
...
- **Organizations API** - Full org management (list, create, delete, members,
  invitations)
...
The API returns an array of branch statuses (one per repo), CLI expects single
object.
...
2. **Add Sessions API**
   ...
   - `followUp(sessionId, prompt, images?)` - POST
