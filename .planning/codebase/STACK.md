...
**Environment:**
- Deno v2.x
  - Key permissions used: `--allow-net`, `--allow-read`, `--allow-write`, `--allow-env`, `--allow-run=git,fzf`
...
**Critical:**
- `@cliffy/*` - All CLI framework components (command building, user input, output formatting)
